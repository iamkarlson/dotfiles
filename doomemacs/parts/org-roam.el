...
(after! org
  ...
  ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
  ;; Org-mode header font sizes and weights for visual hierarchy
  ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;

  (custom-set-faces!
    ;; Org header levels with progressive sizing
    '(org-level-1 :height 1.35 :weight extra-bold)
    ...
    ;; Keep code blocks and tables monospace (bonus feature)
  ...
  (setq org-roam-capture-templates
        `(
          ...
          ("c" "contact" plain (function my/org-roam-capture-contact)
           :if-new (file+head "resources/contacts/%<%Y%m%d%H%M%S>-${slug}.org"
                              "#+title: ${title}\n")
           :target (file "%<%Y%m%d%H%M%S>-${slug}.org")
           :unnarrowed t)
          ;; Idea
